# Procedural World Generator (BYOW)

This project is a 2D tile-based world exploration engine developed as part of  
...
> ⚠️ **Note:** Source code is not included in this repository to comply with  
> UC Berkeley academic integrity policies. This repository serves as a technical
> showcase of the project’s design and functionality.

## Features
- Procedural generation of 2D tile-based worlds
- Deterministic world generation using user-provided seeds
- Main menu for starting new games or loading saved worlds
